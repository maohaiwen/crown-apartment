...
function query(){
	...
	var json = [{"district":district},{"maxmoney":maxmoney},{"type":3},
					...
					<div class="top-menu" style="padding-top: 0px; margin-top: 8px;">
						<nav class="navigation">
							<ul class="cl-effect-16">
								...
								<li><a class="active" href="highb.jsp">high building</a></li>
				    ...
				    <div class="tainers-section" style="margin-top:0px;">
	 				 <div class="container"  style="margin-top:0px;">
						...
						<div class="col-md-9 sreen-gallery-cursual wow bounceInRight"
							 style="height:800px;margin-top:10px;" data-wow-delay="0.4s">
							<div class="linearbg" style="margin-left:20px;width:100%;height:100%;border:1px solid rgba(180,180,180,0.9);">
