...
function query(){
	...
	var json = [{"district":district},{"maxmoney":maxmoney},{"type":4},
				{"minmoney":minmoney},{"shi":shi},{"ting":ting},{"keywords":keywords}];
	$("#page").mypage("submit",json);
}

function getPage(){
	$("#userpage").click(function(){
		$("#ifm").attr("src","user_enquiry.jsp");
	});
	$("#housepage").click(function(){
		$("#ifm").attr("src","addhouse.jsp");
	});
}
...
<style>
.btnn {border:0;background-color: rgba(180, 180, 180, 0.74);color:white;font-weight: bold;}
...
<div style="margin-top:10px;width:100%;">
	<div style="width:100%;overflow: hidden;">
		<iframe id="ifm" src="user_enquiry.jsp" style="width:100%;height:850px;overflow: hidden;border:0;">
