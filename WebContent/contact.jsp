...
function query(){
	...
	var json = [{"district":district},{"maxmoney":maxmoney},{"type":0},
...
<style>
.fonts {border:1px solid rgba(180,180,180,0.5);}
.fonts p{margin-top: 30px;font-size: 22px;padding:10px 10px 10px 10px}
.linear{ 
width:100%; 
height:600px; 
...
<!-- 标题栏 -->
					...
					<div class="top-menu" style="padding-top: 0px; margin-top: 8px;">
						<nav class="navigation">
							<ul class="cl-effect-16">
								...
								<li><a class="active" href="contact.jsp">About us</a></li>
	...
	<div class="fonts" style="width: 60%;margin-left: 20%;margin-top: 3%;">
	<p><font style="font-size: 19px;font-family:Times New Roman; ">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Shanghai Crown Apartment Investment and Management Consulting Firm has been helping Expats find their desired home in Shanghai. 
	</font></p>
	<p><font style="font-size: 19px;font-family:Times New Roman; ">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Established in 2014 Shanghai Crown Apartment offers one of the largest database of Expat Housing inclusive of Developer properties, Vintage apartments, Renovated Lane Houses Villa compounds and local properties.
	</font></p>
	<p><font style="font-size: 19px;font-family:Times New Roman; ">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Apart from real estate rentals Shanghai Crown Apartment wide range of standardized services inclusive of Home search, rental negotiations, check–in support, contract management, payment management, 24/7 after service along with check-out and departure support helps ensure a hassle free relocation. 
	</font></p>
	<p><font style="font-size: 19px;font-family:Times New Roman; ">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;We at Shanghai Crown Apartment are a dedicated team of local as well as foreign property consultants, negotiations experts, contract management and account management specialists along with after service professionals working round the clock to ensure quality to its clients with a passion to exceed expectations. 
	</font></p>	
	</div>
	<!----start-slide-bottom--->
				<!--tainers-section-->
